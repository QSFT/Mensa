 ...
 *
 */
public class Keywords<S> extends HashSet<IKeyword<S>> implements IKeywords<S>
{
	 ...
	 */
	public Keywords(final int initialCapacity_)
	{
	 ...
	 */
	public Keywords(final int initialCapacity_, final float loadFactor_)
	{
	 ...
	 */
	public Keywords(final IKeywords<S> keywords_)
	{
		super(keywords_);
	}
}
